  ...
  <div class="container-fluid h-100 footer">
    <div class="row h-100 justify-content-center align-items-center">
      ...
      <div class="col-lg-3 col-12">
        <img class="float-right m-r-15 ssl-cert" src="/certs/positivessl_trust_seal_lg_222x54_mod.png">
      </div>
    </div>
  </div>
</template>
...
<style>
.footer { background-color: rgb(96, 125, 139); }
.ssl-cert { width: 106px;height: 22px; }
.zmdi { font-size: 25px; }
