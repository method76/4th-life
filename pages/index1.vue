  ...
  <div class="container-fluid">
    ...
    <div class="row m-b-10">
      ...
      <div class="col-lg-4 col-12">
        <h3><i class="zmdi zmdi-tv-alt-play" /> <strong>뉴스</strong></h3>
      ...
      <div class="col-lg-4 col-12">
        <!-- 소셜 글 목록 #1 Start -->
        <h3><i class="zmdi zmdi-face" /> <strong>소셜네트워크</strong></h3>
    ...
    <div class="row clearfix media-wrapper">
      ...
      <div class="col-lg-4 col-12">
        <h3 class="title-latest">
          <i class="zmdi zmdi-trending-up" /> 암호화폐 <strong>시세</strong>
          <a
...
export default {
  ...
  async asyncData ({ params }) {
    return axios.get('https://4th.life/api/news').then((res) => {
