<template>
  ...
  <div class="container-fluid">
    ...
    <div class="row m-b-10">
      <div
        class="carousel slide col-lg-6 col-9 p-0"
        data-ride="carousel"
      >
        <!-- Indicators -->
        ...
        <div class="carousel-inner">
          <div
            id="demo1"
            class="carousel-item"
            style="background-image: url(https://s1.tokenpost.kr/assets/uploads/201902281f7a507d018fea670.jpg);"
          >
            <div class="carousel-caption">
              <h3>토큰포스트</h3>
              <p>日 작년 암호화폐 관련 자금 세탁 ‘10배’ 증가</p>
            </div>
          </div>
          <div
            id="demo2"
            class="carousel-item carousel-item-left"
            style="background-image: url(https://s1.tokenpost.kr/assets/uploads/20190305b14da082e8a03ece1.jpg);"
          >
            <div class="carousel-caption">
              <h3>토큰포스트</h3>
              <p>스타벅스, 백트(Bakkt) 파트너십 일환 ‘암호화폐’ 결제 가능성 제기돼</p>
            </div>
          </div>
          <div
            id="demo3"
            class="carousel-item carousel-item-next carousel-item-left"
            style="background-image: url(https://s1.tokenpost.kr/assets/uploads/201903055f9c082612fd11117.png);"
          >
            <div class="carousel-caption">
              <h3>토큰포스트</h3>
              <p>서클, ‘시드인베스트(SeedInvest)’ 인수 완료…크라우드펀딩·토큰화 결합</p>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-2 col-3 p-0">
        ...
        >
          <img
            src="https://s1.tokenpost.kr/assets/uploads/2019030513481e5cdebc2c838.jpg"
            alt=""
        ...
        >
          <img
            src="https://s1.tokenpost.kr/assets/uploads/20190305c6b477e6a1232e303.png"
            alt=""
            class="img-fluid img-thumbnail"
          >
        </a>
        ...
        >
          <img
            src="https://s1.tokenpost.kr/assets/uploads/20190309267896042fabb8961.jpg"
            alt=""
            class="img-fluid img-thumbnail"
          >
        </a>
        ...
        <table class="table table-bordered table-hover m-b-0 socials">
          <tbody>
            ...
            <tr>
              <td>
                <a
                  href="https://tokenpost.kr/article-6051"
                  class="text-muted ellipsis"
                  target="_blank"
                >
                  스타벅스, 백트(Bakkt) 파트너십 일환 ‘암호화폐’ 결제 가능성 제기돼
                </a>
              </td>
            </tr>
            <tr>
              <td>
                <a
                  href="https://tokenpost.kr/article-6050"
                  class="text-muted ellipsis"
                  target="_blank"
                >
                  서클, ‘시드인베스트(SeedInvest)’ 인수 완료…크라우드펀딩·토큰화 결합
                </a>
              </td>
            </tr>
            <tr>
              <td>
                <a
                  href="https://tokenpost.kr/article-6044"
                  class="text-muted ellipsis"
                  target="_blank"
                >
                  리플, 샌프란시스코 베이 ‘일하기 좋은 중소기업’ 선정
                </a>
              </td>
            </tr>
            <tr>
              <td>
                <a
                  href="https://tokenpost.kr/article-6036"
                  class="text-muted ellipsis"
                  target="_blank"
                >
                  트론·테더, 2019년 2분기 트론 네트워크 내 USDT 발행 파트너십 체결
                </a>
              </td>
            </tr>
            <tr>
          ...
          <div class="col">
            <div class="card w_data_1">
              <div class="body">
                ...
                <a href="http://paxnetnews.com/hotTag1">
                  paxnetnews.com
                </a>
              </div>
            </div>
      ...
      <div class="col">
        <div class="card w_data_1">
          <div class="body">
            <div
              class="dark"
              style="background-image: url('/images/media_logo/ic_zdnet.png');"
            />
      ...
      <div class="col">
        <div class="card w_data_1">
          <div class="body">
            <div
              class="dark"
              style="background-image: url('/images/media_logo/ic_coinness.png');"
            />
      ...
      <div class="col">
        <div class="card w_data_1">
          <div class="body">
            ...
            <a href="http://www.fintechpost.co.kr">
              fintechpost.co.kr
            </a>
          </div>
        </div>
