  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:title', property: 'og:title', content: '포스라이프 - 최신 블록체인 뉴스 포탈' },
      { hid: 'twitter:title', name: 'twitter:title', content: '포스라이프 - 최신 블록체인 뉴스 포탈' },
      { hid: 'description', name: 'description', content: '블록체인 뉴스와 기술서비스 제공, 암호화폐 기념품 판매' },
      { hid: 'og:description', property: 'og:description', content: '블록체인 뉴스와 기술서비스 제공, 암호화폐 기념품 판매' },
      { hid: 'twitter:description', name: 'twitter:description', content: '블록체인 뉴스와 기술서비스 제공, 암호화폐 기념품 판매' },
